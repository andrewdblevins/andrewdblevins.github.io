...
Now what if we want Alice and Bob to keep track of the average mass of the objects as well as the count? At the end of the day we can combine their averages as long as we know the relative number of objects each saw, with the following formula
